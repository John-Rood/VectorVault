...
| xAI | `grok-4.5` (product default) | `grok-4.5` (500k), `grok-4.3` (1M), `grok-4.20`, `grok-4.20-0309-reasoning`, `grok-4.20-0309-non-reasoning` (1M), `grok-build-0.1` (256k), `grok-latest` | up to 1,000,000 | model-dependent |
