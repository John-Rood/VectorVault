...
*For detailed ACT node documentation and examples, see: [ACT Node Documentation](nodes/act-node.md)*
...
#### MCP SERVER Node
*For detailed MCP node documentation and examples, see: [MCP Node Documentation](nodes/mcp-node.md)*
