...
- Model metadata not represented by the token-limit maps (maximum input/output, multimodal support) needs an explicit registry and tests. Do not group siblings that publish different output limits: Claude Fable 5 and Opus 5 allow 128k output, while Sonnet 5 allows 64k.
